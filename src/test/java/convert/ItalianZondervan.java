...
public class ItalianZondervan {
  ...
  public static void main(String[] args) {
    ...
    tocString = ConvUtils.replaceAll(tocString, "_LN_", "it");
    tocString = ConvUtils.replaceAll(tocString, "_TITLE_", "Bibbia Digitale");
    tocString = ConvUtils.replaceAll(tocString, "_HIGHLIGHT_", "digita la parola che ti interessa");
    tocString = ConvUtils.replaceAll(tocString, "_BUTTON_", "cerca");
    tocString.append("<b>Vecchio Testamento</b><br />\n");

    try {
      file = new File("./");
      fileNames = file.list(new ItalianZondervan().new WantDotHTML());
	...
	tocString.append("<a target=\"right_frame\" href=\"" +
			 ...
			 ".htm\">" + bookName + "</a><br />\n");
	if (argno == 38) {
		tocString.append("<br /><b>Nuovo Testamento</b><br />\n");
	}

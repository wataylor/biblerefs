...
public class GermanZondervan {
  ...
  public static void main(String[] args) {
    ...
    tocString = ConvUtils.replaceAll(tocString, "_LN_", "de");
    tocString = ConvUtils.replaceAll(tocString, "_TITLE_", "Die Bible");
    tocString = ConvUtils.replaceAll(tocString, "_HIGHLIGHT_", "Hervorheben im actuellem Buch:");
    tocString = ConvUtils.replaceAll(tocString, "_BUTTON_", "Erforschen");
    tocString.append("<b>Altes Testament</b><br />\n");

    try {
      file = new File("./");
      fileNames = file.list(new GermanZondervan().new WantDotHTML());
	...
	tocString.append("<a target=\"right_frame\" href=\"" +
			 ...
			 ".htm\">" + bookName + "</a><br />\n");
	if (argno == 38) {
		tocString.append("<br /><b>Neues Testament</b><br />\n");
	}
